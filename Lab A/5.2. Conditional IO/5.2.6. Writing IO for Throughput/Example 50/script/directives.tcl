...
set_directive_interface -mode ap_fifo "accumulate" flag
set_directive_array_reshape -type complete -dim 1 "accumulate" flag
set_directive_unroll "accumulate/DIN"
